...
DOB.place(x=30,y=88)
user = DateEntry(frame2,fg="black",border=0,bg="white",font=("Microsoft Yahei UI Light",14),width=13)
...
def result():
    ...
    if sleep:
        ...
        OM1=Entry(tableframe1,width=10,fg="black",border=0,bg="white",font=buttonFont2)
        OM1.place(x=667,y=85)

        OM2=Entry(tableframe1,width=10,fg="black",border=0,bg="white",font=buttonFont2)
        OM2.place(x=667,y=125)

        OM3=Entry(tableframe1,width=10,fg="black",border=0,bg="white",font=buttonFont2)
        OM3.place(x=667,y=165)

        OM4=Entry(tableframe1,width=10,fg="black",border=0,bg="white",font=buttonFont2)
        OM4.place(x=667,y=205)

        OM5=Entry(tableframe1,width=10,fg="black",border=0,bg="white",font=buttonFont2)
        OM5.place(x=667,y=245)

        OM6=Entry(tableframe1,width=10,fg="black",border=0,bg="white",font=buttonFont2)
        ...
        # print('studentid', check_student_id)
        data=cd.fetchall()
        # print('marks',data)
...
c=Button(frame2,width=35,pady=7,text="Fetch Result",bg="#57a1f8",fg="white",border=0,font=buttonFont1,activebackground="#57a1f8",activeforeground="white",command=result)
c.place(x=18,y=235)
c.bind('<Enter>',o_enter)
c.bind('<Leave>',o_leave)

# b=Button(project,text="top",command=view).pack()
